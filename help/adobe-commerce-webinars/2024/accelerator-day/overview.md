...
| **Evolução da experiência: Commerce, Data e você** | Uma visão geral e demonstração da personalização do Commerce usando o [!DNL Real-Time Customer Data Platform], [!DNL Journey orchestration] e o Adobe [!DNL Experience Platform] integrado | <ul><li>Mike Lynch - Especialista [!DNL Commerce] corporativo, Adobe</li></ul> | [Assista ao vídeo](./experience-evolution.md) |
