---
title: O relatório do Workfront dos seus sonhos EXISTE! Duas Abordagens para Dominar Instruções EXISTS
description: Conhecimento técnico e aplicativos práticos para nos mostrar como usar as instruções EXISTS para criar relatórios mais inteligentes
...
# O relatório do Workfront dos seus sonhos EXISTE! Duas Abordagens para Dominar Instruções EXISTS

Pronto para elevar o nível dos seus relatórios do Workfront?  Veja como Skye Hansen e Nathan Johnson ofereceram duas perspectivas sobre a criação de declarações EXISTS que podem tornar realidade seus sonhos de divulgação.

Durante esse workshop, eles compartilharam conhecimentos técnicos e aplicações práticas para nos mostrar como usar as instruções EXISTS para criar relatórios mais inteligentes.
