        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="2025/proactive-monitoring-tools.md" title="Por trás da brecha - um detalhamento completo das ferramentas de monitoramento pró-ativo" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3459035/?format=jpeg&nocache=1750103136004" alt="Por trás da brecha - um detalhamento completo das ferramentas de monitoramento pró-ativo"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="2025/proactive-monitoring-tools.md" target="_blank" rel="referrer" title="Por trás da brecha - um detalhamento completo das ferramentas de monitoramento pró-ativo">Por Trás da Cerveja - Um Detalhamento Completo das Ferramentas de Monitoramento Pró-ativo</a>
                    </p>
                    <p class="is-size-6">Junte-se a nós para saber como a SWAT, o Fastly e o New Relic permitem o monitoramento pró-ativo, o diagnóstico eficiente de problemas e o rastreamento contínuo da integridade do sistema para obter o desempenho ideal.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Integre o Adobe Commerce a qualquer aplicativo de comércio eletrônico usando a orientação de especialistas da App Builder e a demonstração em tempo real</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Adobe Commerce Intelligence (fka MBI)">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="2025/commerce-intelligence.md" target="_blank" rel="referrer" title="Adobe Commerce Intelligence (fka MBI)">Adobe Commerce Intelligence (MBI fka)</a>
                    </p>
                    <p class="is-size-6">Transforme seus dados de comércio eletrônico em insights acionáveis com painéis e relatórios personalizados do Adobe Commerce Intelligence</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="A Deep Dive into Live Search">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="2025/deep-dive-live-search.md" title="Aprofundamento do Live Search" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3443021/?format=jpeg&nocache=1750103135990" alt="Aprofundamento do Live Search"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="2025/deep-dive-live-search.md" target="_blank" rel="referrer" title="Aprofundamento do Live Search">Aprofundamento do Live Search</a>
                    </p>
                    <p class="is-size-6">Personalize sua experiência do Live Search no Adobe Commerce com orientações de especialistas e exemplos de implementação prática</p>
                </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="2025/commerce-storefront.md" title="Otimizar sua vitrine do Commerce" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3443031/?format=jpeg&nocache=1750103135956" alt="Otimizar sua vitrine do Commerce"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
