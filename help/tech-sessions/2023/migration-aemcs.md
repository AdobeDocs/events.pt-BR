...
Nesta sessão, você verá as técnicas e ferramentas disponíveis para facilitar a migração para o AEM Cloud Service. Da ferramenta Transferência de conteúdo para a nova Cloud Acceleration Manager usada em conjunto com o Analisador de práticas recomendadas para avaliar seu ambiente, não perca essa sessão de ativação para garantir que você esteja pronto para uma ativação bem-sucedida no Cloud Service.
