...
**Para continuar a discussão, visite a [discussão na Comunidade do Experience League](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-platform/experience-league-live-post-session-discussion-are-you-ready-to/m-p/704990?profile.language=pt#M550){target="_blank"}.**
...
Você também ouviu dizer que a Coleta de dados da Edge é o futuro do ecossistema da Adobe, permitindo que você aproveite outras soluções, como a Real-Time CDP, o Journey Optimizer e o Customer Journey Analytics.
...
Após a migração, ainda é possível acessar seus dados no Analytics, aproximando-o um pouco mais do AEP. Ainda não tem certeza? Mostraremos como validar sua implementação e depurar em tempo real.
