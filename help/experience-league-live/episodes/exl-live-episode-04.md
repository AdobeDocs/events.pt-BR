...
description: Entender a jornada do cliente é tudo. E relatar a interação do usuário com sua propriedade da web ou móvel é o que permite que você alcance esse entendimento. O Adobe [!DNL Analytics] mostra quem, o quê, por que e onde de cada clique em seu aplicativo, e vamos nos aprofundar em como aproveitar ao máximo em nosso evento ao vivo de 21 de outubro. Mostraremos como usar Classificações com o Activity Map para entender melhor o comportamento do usuário e criar um gráfico fácil dos cliques que levam a atividades valiosas do site.
