...
Junte-se a Bryan, Eric e Doug enquanto discutem como começar rapidamente a usar o Customer Journey Analytics (CJA). Você aprenderá a usar processos automatizados para mover dados e análises do Adobe Analytics para o CJA, bem como sobre quaisquer armadilhas a serem consideradas durante o processo. E é claro, eles terão uma boa dose de dicas e truques divertidos pelo caminho.
...
* Há duas maneiras de obter dados do Adobe Analytics para o Customer Journey Analytics: o Conector de dados do Analytics (ADC) e o Web SDK.
* O ADC permite que os dados de um conjunto de relatórios sejam copiados no Adobe Experience Platform para análise, enquanto o Web SDK envia dados diretamente para o Adobe Experience Platform.
...
* Há uma nova ferramenta chamada &quot;migração de componentes&quot; que permite aos administradores do Adobe Analytics migrar projetos para o CJA.
* Ao migrar um projeto, todos os componentes nas tabelas, bem como qualquer segmento ou métrica calculada aplicada, são movidos para o CJA.
* Há um processo de mapeamento em que os componentes que não existem no CJA podem ser mapeados usando campos abrangentes ou derivados.
* É recomendável criar um capturador para elementos que não existem no CJA e, em seguida, editá-los no projeto de destino.
* Anteriormente, acreditava-se que as métricas calculadas e os segmentos precisavam ser recriados ao migrar para o CJA, mas agora há uma opção para migrá-los.
