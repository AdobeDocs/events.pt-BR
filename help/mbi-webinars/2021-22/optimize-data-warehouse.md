---
title: Otimizar o Commerce Intelligence Data Warehouse
...
# Otimizar o Commerce Intelligence Data Warehouse
...
Usando o Data Warehouse Manager, você pode gerenciar configurações de sincronização de tabela e coluna, detalhar um esquema de tabela e criar colunas calculadas para usar em relatórios.

>[!NOTE]
>
>O acesso ao Data Warehouse Manager exige permissões de administrador.
...
- Visualizações do Data Warehouse
...
[Dimensões de Dados Recomendadas para Segmentação e Filtragem](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/best-practices/data/segment-filter.html)
